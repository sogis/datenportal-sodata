...
- Der PNG-Regressionstest verwendet den Serien-Explore-Pfad, validiert die heruntergeladene Datei als PNG und schlägt bei einem Ergebnis-Alert oder den früheren `html-to-image`-Fehlermeldungen für remote CSS und den Font-Inliner fehl. Der ursprüngliche Test prüfte nur eine nichtleere Datei in Chromium und konnte den Firefox-spezifischen Font-Pfad deshalb nicht erkennen.
