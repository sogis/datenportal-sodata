...
- Detailseite einer Datenreihen-Ausgabe zeigt den Serienkontext im Kicker, bei der aktuellen Ausgabe ein Info-Badge im Titel, danach die Dataset-Detail-Cards und eine schlanke Card `Weitere Ausgaben`.
