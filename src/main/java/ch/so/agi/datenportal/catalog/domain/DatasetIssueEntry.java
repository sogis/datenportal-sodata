...
public record DatasetIssueEntry(
    ...
    public DatasetIssueEntry {
        ...
        Objects.requireNonNull(issueLabel, "issueLabel must not be null");
    }

    @Override
    public CatalogEntryType type() {
        return CatalogEntryType.DATASET_ISSUE;
    }
